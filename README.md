...
- [incuse](https://github.com/netwerk-io/incuse) — Ephemeral GitHub Actions runners on Incus VMs
- [qbouncer](https://github.com/vegardx/qbouncer) — Sync qBittorrent's listening port with NAT-PMP over WireGuard
